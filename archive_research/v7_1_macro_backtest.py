...
def run_environmental_macro_backtest():
    logging.info("=== PHASE 14: ENVIRONMENTAL MACRO BACKTEST (V7.1) ===")
    logging.info("Loading V7 Features: Track Bias & Surface Friction...")
    ...
    features = [
        ...
        'ESI_Track_Bias', 'CSI_Surface_Friction' # <-- The New Physics
    ]
    ...
    logging.info("\nStage 1: Training XGBRanker with Environmental Physics (2018-2021)...")
    ...
    for (date, race_id), race_data in races:
        ...
        if race_risk_total > 0:
            bankroll -= (bankroll * race_risk_total)
    ...
    logging.info("\n=== V7 ENVIRONMENTAL MACRO DEBRIEF ===")
...
if __name__ == "__main__":
    run_environmental_macro_backtest()
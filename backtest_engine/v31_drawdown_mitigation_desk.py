...
def main():
    logging.info("=== INITIALIZING PHASE 54: DRAWDOWN MITIGATION DESK ===")
    ...
    # --- The Vigesimal-Kelly Risk Limit ---
    KELLY_MULT = 0.05 
    
    EV_THRESHOLD = 1.05 
    RAKE = 0.23 
    
    logging.info("Executing Structural Anchor Sweep (1/20th Kelly Fraction)...")
    total_action = 0.0
    trios_hit = 0
    races_bet = 0
    max_drawdown = 0.0
    ...
    print("\n" + "="*50)
    print("=== FINAL V31 DRAWDOWN MITIGATION LEDGER ===")
    print("="*50)
